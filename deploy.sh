...
ORG_CHAT_API_ORIGIN="${ORG_CHAT_API_ORIGIN:-$PROD_CHAT_API_ORIGIN}"
...
write_pidp_config() {
  ...
  export PIDP_PORTAL_AUTH_ORIGINS
...
const config = {
  ...
  vars: {
    ...
    PORTAL_AUTH_ORIGINS: env.PIDP_PORTAL_AUTH_ORIGINS,
...
const config = {
  ...
  vars: {
    ...
    CHAT_API_ORIGIN: env.ORG_CHAT_API_ORIGIN,
